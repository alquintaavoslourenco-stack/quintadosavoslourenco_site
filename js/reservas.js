/* /js/reservas.js — Simulador + spinners + Formspree
   137€/noite (1–2 adultos), +35€/adulto/noite acima de 2;
   Crianças 0–4: gratuito; 2–30 noites; capacidade 7 (adultos+crianças).
*/
(function () {
  'use strict';
  ...
  document.addEventListener('DOMContentLoaded', () => {
    const els = {
      ...
      msg:      $('#sim-msg'),
      consentTerms: $('#consent-terms'), consentPrivacy: $('#consent-privacy'),
    ...
    // capacidade: adultos + crianças <= 7 (bloqueia crianças quando adultos = 7)
    ...
    // Evitar teclado nos campos Adultos/Crianças
    ...
    try {
      ...
      const q1 = computeQuote('2025-01-01','2025-01-03',2,2);
